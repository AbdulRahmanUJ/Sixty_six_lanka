...
@section('title', 'Super Admin | Packages')
@section('content')
...
<section class="superadmin_package">
                              ...
                              <tr>
                                  ...
                                  <tr>
                                      @foreach ($all_packages as $all_packages)
                                          <tr>
                                              <td><a href="/superadmin/package/show/{{ $all_packages->id }}">{{ $all_packages->track_no }}</a></td>
                      ...
                      <tbody>
                            ...
                            <tr>
                                ...
                                @foreach ($pending as $pendings)
                                    <tr>
                                        <td><a href="/superadmin/package/show/{{ $pendings->id }}">{{ $pendings->track_no }}</a></td>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            @foreach ($approved as $approves)
                                <tr>
                                    <td><a href="/superadmin/package/show/{{ $approves->id }}">{{ $approves->track_no }}</a></td>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            @foreach ($delivered as $delivers)
                                <tr>
                                    <td><a href="/superadmin/package/show/{{ $delivers->id }}">{{ $delivers->track_no }}</a></td>
                        ...
                        <tbody>
                              @if (count($canceled)>0)
                                ...
                                @foreach ($canceled as $cancels)
                                    <tr>
                                        <td><a href="/superadmin/package/show/{{ $cancels->id }}">{{ $cancels->track_no }}</a></td>
            ...
            <div class="col-sm-12">
                <div class="">
                    @if (count( $packages)>0)
                        ...
                        <li style="background: {{ $package->deliverystatus->color }}" title="{{$package->created_at->format('y-m-d')}}"><a class="text-dark" href="/superadmin/package/show/{{ $package->id }}">{{$package->track_no}}</a><span title="Move to Redy to Ship">&nbsp; <a href="/superadmin/package/rdy_to_ship/{{$package->id}}"><i data-feather="chevrons-right"></i></a></span></li><hr>
                        @endforeach
                    @else
