...
@section('title', 'Super Admin | Edit Receiver Address')
@section('content')
@section('dashboard_title', 'Edit Receiver Address')
<section class="edit_receiver_address">
    <div class="card">
        <div class="card-body">
            <form action="/superadmin/receiver_address/{{ $receiver_address->id }}" name="receiver_form" method="POST">
                @method('PATCH')
                @csrf
                <div class="form-row">
