...
@section('title', 'Admin | Create Package')
...
<section class="admin_package_create">
    <form action="/admin/package" name="package" id="cart" method="POST">
        @csrf
        <div class="card py-3 px-2">
            ...
            <div class="row">
                ...
                <div class="col-1 mt-3 pt-3">
                    <a href="/admin/sender" style="font-size: 18px; font-weight:700" class="bg-success rounded py-1 px-4 text-dark">+</a>
                </div>
            </div>
        ...
        <div class="card py-3 px-2">
            ...
            <div class="row">
                ...
                <div class="col-1 mt-3 pt-3">
                    <a href="/admin/receiver" style="font-size: 18px; font-weight:700" class="bg-success rounded py-1 px-4 text-dark">+</a>
                </div>
            </div>
                ...
                <table class="table mb-0 price" name="package">
                    <tbody>
                        <tr name="line_items" style="border-bottom: 1px solid #c9c9c9">
                            ...
                            <td class="col-3"><input type="number" name="sub_total" class="form-control text-right col-5 float-right" jAutoCalc="{weight} * {price_per_kg}" value='0' required></td>
                        </tr>
                        <tr class="line_items">
