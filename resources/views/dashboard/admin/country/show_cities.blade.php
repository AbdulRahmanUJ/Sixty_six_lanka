        ...
        <div class="card">
            <div class="col-md-12">
                <div class="card-body col-md-5 float-right">
                    <form action="/admin/city/{{ $state->id  }}" method="POST">
                        @csrf
                            ...
                            @foreach ($cities as $city)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-sm-center">
                                        <a href="/admin/city/edit_city/{{$city->id}}" title="Edit city {{$city->name}}"><i class="text-success" data-feather="edit"></i></a>
                                        <form action="/admin/city/delete/{{$city->id}}" method="POST">
                                            @method('DELETE')
                                            @csrf
