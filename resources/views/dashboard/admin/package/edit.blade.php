...
<section class="admin_package_edit">
    <form action="/admin/package/{{ $package->id }}" id="form" method="POST">
        @method('PATCH')
        @csrf
        @if ($package->sender)
                ...
                <table class="table mb-0 price" id="">
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td class="float-left"><input type="number" name="price_per_kg" class="form-control" value="{{old('price_per_kg', $package->price_per_kg)}}" readonly></td>
