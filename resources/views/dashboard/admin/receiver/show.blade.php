...
@section('title', 'Admin | Show Receiver')
@section('content')
@section('dashboard_title', 'Details of Receiver '.$receiver->name)
<section class="admin_show_receiver">
        ...
        <div class="row flex justify-content-center">
                ...
                <div class="card-body">
                    ...
                    @foreach ($receiver_address as $item)
                        ...
                        <div class="row float-right">
                            ...
                            <a title="Delete {{ $receiver->name }}s Address" id='deleteAddress' data-id="{{ $item->id }}" class='btn text-danger deleteAddress'><i data-feather="trash-2"></i></a>
                            @endif
                            <a href="/admin/receiver_address/edit/{{$item->id}}" id='editAddress' class='btn text-primary editAddress'><i data-feather="edit"></i></a>
                        </div>
                        <br>
                        <hr style="border-color: red">
                    @endforeach
            ...
            <div class="row col-12 flex justify-content-center">
                <a href="/admin/receiver_address/add/{{$receiver->id}}" class="border border-info rounded bg-info text-light py-1 px-3 ">Add New Address</a>&nbsp;&nbsp;&nbsp;
                <a href="/admin/receiver/edit/{{$receiver->id}}" class="border border-secondary rounded bg-secondary text-light py-1 px-3">Edit</a>&nbsp;&nbsp;&nbsp;
                <form action="/admin/receiver/delete/{{$receiver->id}}" method="POST">
                    @method('DELETE')
                    @csrf
