            ...
            <div class="card-body">
                <div class="tab-content">
                                                ...
                                                @foreach ($senders as $sender)
                                                    <tr>
                                                        ...
                                                        <td class="d-flex justify-content-sm-center">
                                                            {{-- <a href="/admin/package/create/{{$sender->id}}" title="Add Package to {{$sender->name}}"><i class="text-primary" data-feather="file-plus"></i></a> --}}
                                                            <a href="/admin/sender/edit/{{$sender->id}}" title="Edit Sender {{$sender->name}}" style="margin: auto 10px"><i class="text-success" data-feather="edit"></i></a>
                    ...
                    <div class="tab-pane fade" id="add_sender" role="tabpanel">
                        <form action="/admin/sender" name="sender_form" method="POST">
                            @csrf
                            <div class="form-row">
...
<script src="{{asset('js/jquery.js')}}"></script>
    ...
    @section('scripts')
    <script type="text/javascript">
        var route = "{{ url('admin/search_sender') }}";
