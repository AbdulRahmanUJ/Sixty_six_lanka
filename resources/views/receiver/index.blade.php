        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills card-header-pills pull-right float-right" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab"  href="#receiver_table">Receivers List <i class="fa fa-list" aria-hidden="true"></i> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#add_receiver"> Add Receiver <i class="fa fa-user-plus" aria-hidden="true"></i></a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                                        ...
                                        <table class="table mb-0  table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($receivers as $receiver)
                                                    <tr>
                                                        <td><a href="/receiver/show/{{$receiver->id}}" title="View Receiver {{$receiver->name}}">
                                                                {{ $receiver->name }}
                                                            </a>
                                                        </td>
                                                        <td>{{ $receiver->phone }}</td>
                                                        <td class="d-flex justify-content-sm-center">
                                                            {{-- <a href="receiver/package/create/{{$receiver->id}}" title="Add Package to {{$receiver->name}}"><i class="text-primary" data-feather="file-plus"></i></a> --}}
                                                            <a href="/receiver/edit/{{$receiver->id}}" title="Edit receiver {{$receiver->name}}"><i class="text-success" data-feather="edit"></i></a>
