...
class User_Receiver_addressController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('receiver/index')->with([ 'receivers'=> $receiver, 'countries'=> $countries]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $id = $receiver->id;
        return redirect('/receiver/show/'.$id)->with('success', 'Receiver Successfully Created');
    }
    ...
    public function show($id)
    {
        ...
        if (auth()->id() != $receiver->admin_id) {
            return redirect('receiver') -> with('error', 'You are not Owner of this Record');
        } else {
            return view('receiver.show',
                [
                    "receiver"=>$receiver,
                    "packages"=>$package,
    ...
    public function edit($id)
    {
        ...
        return view('receiver.edit', ['receiver'=>$receiver, 'countries'=>$countries]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $receiver->phone=$request->phone;
        $receiver->update();
        return redirect('/receiver/show/'.$id)->with('success', 'Receiver Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        if (auth()->id() != $receiver->admin_id) {
            ...
            $receiver->delete();
            return redirect('/receiver') -> with('success', 'Receiver Successfully Deleted');
        }
    }
}
