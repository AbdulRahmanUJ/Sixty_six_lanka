            ...
            <div class="card-body">
                <div class="tab-content">
                                        ...
                                        <table class="table mb-0  table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($receivers as $receiver)
                                                    <tr>
                                                        <td><a href="/admin/receiver/show/{{$receiver->id}}" title="View Receiver {{$receiver->name}}">
                                                                {{ $receiver->name }}
                                                            </a>
                                                        </td>
                                                        <td>{{ $receiver->phone }}</td>
                                                        <td class="d-flex justify-content-sm-center">
                                                            {{-- <a href="/admin/package/create/{{$receiver->id}}" title="Add Package to {{$receiver->name}}"><i class="text-primary" data-feather="file-plus"></i></a> --}}
                                                            <a href="/admin/receiver/edit/{{$receiver->id}}" title="Edit receiver {{$receiver->name}}"><i class="text-success" data-feather="edit"></i></a>
                    ...
                    <div class="tab-pane fade" id="add_receiver" role="tabpanel">
                        <form action="/admin/receiver" method="POST">
                            @csrf
                            <div class="form-row">
