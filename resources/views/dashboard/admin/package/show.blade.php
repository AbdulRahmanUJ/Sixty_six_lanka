...
@section('title', 'Admin | Show Package')
<style>
    #more{
        /* display: none; */
    }
...
<section class="package_show">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <form action="/admin/package/change_status/{{ $package->id }}" id="form" method="post">
                            @method("patch")
                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 text-secondary">
                                @foreach ($pre_order_user as $pre_order_user)
                                    <a href="/admin/user/show/{{$pre_order_user->id}}">{{$pre_order_user->name}}</a>
                                @endforeach
                            </div>
                        </div>
                        <hr>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-7 text-secondary">
                                @if ($package->sender)
                                <a href="/admin/sender/show/{{ $package->sender->id }}">{{$package->sender->name}}</a>
                                @else
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-7 text-secondary">
                                @if ($package->receiver)
                                    <a href="/admin/receiver/show/{{$package->receiver->id}}">{{$package->receiver->name}}</a>
                                @else
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                @if ($package->is_pickup != 1)
                    <div class="card col-12">
                        <form action="/admin/package/pickup/{{ $package->id }}" method="post" enctype="multipart/form-data">
                            @method('patch')
                            @csrf
            ...
            <div class="row">
                @if ($package->is_cancel != 1)
                    <div class="card col-12">
                        <form action="/admin/package/cancel/{{ $package->id }}" method="post">
                            @method('patch')
                            @csrf
                    ...
                    <div class="card col-12">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form action="/admin/package/remove_cancel/{{ $package->id }}" id="cancel_remove_form" method="post">
                                    @method('PATCH')
                                    @csrf
                                    <label class="toggle switch">
    ...
    <div class="container d-flex justify-content-left">
        <a href="/admin/package/edit/{{$package->id}}" class="border-white bg-white rounded text-primary text-center py-1 px-2"><i data-feather="edit" aria-hidden="true"></i> Edit</a> &nbsp; &nbsp;
        <a href="/admin/package/preview/{{$package->id}}" class="border-white bg-white rounded text-success text-center py-1 px-2"><i data-feather="file-text" aria-hidden="true"></i> Preview</a> &nbsp; &nbsp;
        <form action="/admin/package/delete/{{$package->id}}" method="POST">
            @method('DELETE')
            @csrf
