...
class ReceiverController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.superadmin.receiver/index')->with([ 'receivers'=> $receiver, 'countries'=> $countries]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $id = $receiver->id;
        return redirect('/superadmin/receiver/show/'.$id)->with('success', 'Receiver Successfully Created');
    }
    ...
    public function show($id)
    {
        ...
        $package = Package::where('receiver_id', '=', $id)->get();
            return view('dashboard.superadmin.receiver.show',
                [
                    "receiver"=>$receiver,
                    "packages"=>$package,
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.superadmin.receiver.edit',
            [
                'receiver'=>$receiver,
                'countries'=>$countries
            ]
    ...
    public function update(Request $request, $id)
    {
        ...
        $receiver->phone=$request->phone;
        $receiver->update();
        return redirect('/superadmin/receiver/show/'.$id)->with('success', 'Receiver Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        $receiver = Receiver::findOrFail($id);
        $receiver->delete();
        return redirect('/superadmin/receiver') -> with('success', 'Receiver Successfully Deleted');
    }
}
