...
<body>
	<div class="wrapper">
				...
				<ul class="sidebar-nav">
					...
					{{-- <li class="sidebar-item">
						<a href="#" data-toggle="collapse" class="sidebar-link collapsed">
							<i class="align-middle" data-feather="briefcase"></i> <span class="align-middle">Receivers</span>
						</a>
                    ...
                    <ul id="package" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                        <li class="sidebar-item">
                            <a class="sidebar-link {{request()->is('admin/package/create')?'active':''}}" href="/admin/package/create">
                                <i class="align-middle"></i> <span class="align-middle">Create Packages</span>
                            </a>
                        </li>
                    </ul>
					<li class="sidebar-item">
						<a class="sidebar-link {{request()->is('/admin/sender')?'active':''}}" href="/admin/sender">
							<i class="align-middle" data-feather="send"></i> <span class="align-middle">Senders</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link {{request()->is('/admin/receiver')?'active':''}}" href="/admin/receiver">
							<i class="align-middle" data-feather="users"></i> <span class="align-middle">Recivers</span>
						</a>
					</li>
                    <li class="sidebar-item">
						<a class="sidebar-link {{request()->is('/admin/country')?'active':''}}" href="/admin/country">
		...
		<div class="main">
			<nav class="navbar sticky navbar-expand navbar-light navbar-bg">
					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right">
								...
								<a class="dropdown-item" href="/admin/setting"><i class="align-middle mr-1" data-feather="settings"></i> Settings & Privacy</a>
								{{-- <a class="dropdown-item" href="#"><i class="align-middle mr-1" data-feather="help-circle"></i> Help Center</a> --}}
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="{{ route('logout') }}"onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();"><i class="align-middle mr-1" data-feather="log-out"></i>{{ __('Logout') }}</a>
